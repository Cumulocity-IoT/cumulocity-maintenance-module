...
/**
 * Schema for creating a new maintenance plan (excludes the auto-generated ID)
 * 
 * @author APES
 */
public class MaintenancePlanCreate {
    ...
    // Default constructor
    public MaintenancePlanCreate() {}

    // Constructor
    public MaintenancePlanCreate(String name, String description, LocalDateTime startDate, 
