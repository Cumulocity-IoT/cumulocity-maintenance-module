...
public class MaintenancePlanController {
    ...
    public ResponseEntity<MaintenancePlanListResponse> getAllMaintenancePlans(
            ...
            @RequestParam(value = "startDate", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) DateTime startDate,
            @RequestParam(value = "endDate", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) DateTime endDate,
    ...
    public ResponseEntity<MaintenancePlan> getMaintenancePlan(@PathVariable("id") Integer id) {
    ...
    public ResponseEntity<Void> deleteMaintenancePlan(@PathVariable("id") Integer id) {
