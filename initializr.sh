...
# Note: This file is filtered by the Maven archetype. Only maintenance-module is intentional.

set -eo pipefail

MICRO_NAME="maintenance-module"  # replaced by archetype at generation time
